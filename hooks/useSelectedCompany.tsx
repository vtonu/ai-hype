...
const SelectedCompanyContext = React.createContext<SelectedCompanyContextType | undefined>(
  undefined,
);

// Create a provider component
export const SelectedCompanyProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
